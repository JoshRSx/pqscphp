...
*/
    ...
    <div class="contimg">  <div class="xfg"></div> <?php try{ if (@getimagesize($base64_2)) { echo "<img src= $base64_2 ?>"; } elseif(@getimagesize($base64bg_2)&& @getimagesize($base64fg_2)){ echo "<img src= $base64bg_2 ?>"; echo "<img src= $base64fg_2 ?>"; }else if(@getimagesize($base64bg_2) && @getimagesize($base64_2a)) { echo "<img src= $base64bg_2 ?>"; echo " <img src= $base64_2a ?>"; }  else{ echo '<img src=" ">'; } } catch(Exception $e){} ?> </div> <br>
