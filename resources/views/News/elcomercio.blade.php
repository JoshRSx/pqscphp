...
*/
    ...
    <div class="contimg">  <div class="xfg"></div> <?php if (@getimagesize($base64_2)) { echo "<img src= $base64_2 ?>" or die("File Not Found!!"); } elseif(@getimagesize($base64bg_2)&& @getimagesize($base64fg_2)){ echo "<img src= $base64bg_2 ?>" or die("File Not Found!!"); echo "<img src= $base64fg_2 ?>" or die("File Not Found!!");  }else if(@getimagesize($base64bg_2) && @getimagesize($base64_2a)) { echo "<img src= $base64bg_2 ?>" or die("File Not Found!!"); echo " <img src= $base64_2a ?>" or die("File Not Found!!");  }  else{ echo '<img src=" ">'; or die("File Not Found!!")} ?> </div> <br>
